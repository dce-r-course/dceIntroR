...
They combine code, text, and output (tables, plots, etc.) in one document that can be turned into an HTML, PDF, or Word report.
...
- Text and code are clearly separated, as code must be placed inside code chunks.

- The output (*e.g.*, results, tables, or plots) appears immediately below the code that produced it.

- This structure might make it easier to follow the logic of your analysis.
...
You can access a "Table of Contents" view in the "Outline" pane on the right-hand side of your Source pane.
...
In your R Script file, you can create a section header by pressing `Ctrl + Shift + R` and typing "First header".
...
4.  R Studio will automatically reformat your code, *e.g.,* fixing spacing, indentation, and line breaks while keeping your code the same.
