...
However, the current working directory may not be the place where your data is stored. For example, maybe your data is stored in a folder called `data-raw`.
