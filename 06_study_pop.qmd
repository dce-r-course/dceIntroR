...
We will be using the `str_detect` function from `stringr`. Essentially, what we should know about `str_detect` for now is that it takes the argument: (1) which column; (2) to search for what.
